...
city_states = Card(name='City States', age=1, color='purple',
                    dogma=Dogma(), left=['castle'], right=[None, 'crown'],
                    up=['crown', 'crown', 'castle'])

writing = Card(name='Writing', age=1, color='blue',
                    dogma=Dogma(), left=['crown'], right=[None, 'bulb'],
                    up=['bulb', 'bulb', 'crown'])

tools = Card(name='Tools', age=1, color='blue',
                    dogma=Dogma(), left=['castle'], right=[None, 'bulb'],
                    up=['bulb', 'bulb', 'castle'])

pottery = Card(name='Pottery', age=1, color='blue',
                    dogma=Dogma(), left=['leaf'], right=[None, 'leaf'],
                    up=['leaf', 'leaf', 'leaf'])

sailing = Card(name='Sailing', age=1, color='green',
                    dogma=Dogma(), left=['crown'], right=['crown', 'crown'],
                    up=['crown', None, 'leaf'])
...
archery = Card(name='Archery', age=1, color='red',
                    dogma=Dogma(), left=['castle'], right=['castle', 'bulb'],
                    up=['bulb', None, 'castle'])
...
philosophy = Card(name='Philosophy', age=2, color='purple',
                    dogma=Dogma(), left=['bulb'], right=[None, 'bulb'],
                    up=['bulb', 'bulb', 'bulb'])
...
calendar = Card(name='Calendar', age=2, color='blue',
                    dogma=Dogma(), left=['bulb'], right=[None, 'leaf'],
                    up=['leaf', 'leaf', 'bulb'])
...
currency = Card(name='Currency', age=2, color='green',
                    dogma=Dogma(), left=['crown'], right=['leaf', 'crown'],
                    up=['crown', None, 'crown'])
...
fermenting = Card(name='Fermenting', age=2, color='yellow',
                    dogma=Dogma(), left=['castle'], right=['leaf', 'leaf'],
                    up=['leaf', None, 'castle'])

canal_building = Card(name='Canal Building', age=2, color='yellow',
                    dogma=Dogma(), left=['crown'], right=[None, 'crown'],
                    up=['crown', 'leaf', 'crown'])
